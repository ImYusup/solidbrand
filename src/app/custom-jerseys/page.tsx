// src/app/custom-jerseys/page.tsx
"use client";

import Link from "next/link";
import { jerseyCategories, customJersey } from "@/data/customJersey";

export default function CustomJerseyPage() {
  const allProducts = Object.entries(customJersey).flatMap(
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-gray-600">
            Premium OEM, ODM & Private Label custom jersey manufacturing for teams,
            clubs, companies, schools, communities, and brands worldwide.
          </p>
        </div>
            ...
            <div className="sticky top-24 rounded-3xl border bg-white p-8 shadow-sm">
              ...
              <nav className="flex flex-col gap-3">
                ...
                {jerseyCategories.map((category) => (
                  <Link
                    key={category.id}
                    href={`/custom-jerseys/${category.id}`}
              ...
              {allProducts.map((product, index) => (
                ...
                >
                  ...
                  <div className="border-t pt-6">
                    <Link
                      href={`/custom-jerseys/${product.categoryKey}`}
