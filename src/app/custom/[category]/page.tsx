// src/app/custom/[category]/page.tsx
"use client";
...
export default function BagCategoryPage({ params }: Props) {
    ...
    const data: CustomCategory | undefined = customBag[category];
    ...
    const getWhatsAppLink = (planName: string) => {
        ...
        const text = [
            ...
            "",
            "Preferred Material (Please Select):",
            "- Standard: Cordura / Taslan",
            "- Premium: Canvas / Corduroy Bimo / Filamen",
            "",
            "Order Information:",
            ...
            "",
            "Please send me the quotation, available materials, and production details.",
            "",
            "Thank you!",
        ].join("\n");
